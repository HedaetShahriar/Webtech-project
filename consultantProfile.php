<?php
    ...
    $sql = "SELECT `Id`, `Name`, `Email`, `Contact`, `Password`, `Role`, `consultancyType`, `image` FROM `users` WHERE `Name` = '$username'";
    ...
    if (isset($_POST['updateUser'])) {
        ...
        $sql = "UPDATE users SET Name='$name', Email='$email', consultancyType='$consultancyType', Contact='$contact', Password='$password', image='$imagePath' WHERE Id=$userId";
        if ($conn->query($sql)) {
...
<body class="manrope-font">
                ...
                <form id="profileForm" enctype="multipart/form-data">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-details">
                            ...
                            <div>
                                <span style="margin-right: 10px;" id="consultant-type-display">
                                    <?php echo $user['consultancyType'];?>
                                </span>
                                <select id="consultant-type-dropdown" class="consultant-dropdown" onchange="updateConsultantType(event)">
                                    <option value="Online" <?php echo $user['consultancyType'] == 'Online' ? 'selected' : ''; ?>>Online</option>
                                    <option value="Family" <?php echo $user['consultancyType'] == 'Family' ? 'selected' : ''; ?>>Family</option>
                                    <option value="Personal" <?php echo $user['consultancyType'] == 'Personal' ? 'selected' : ''; ?>>Personal</option>
                                </select>
    ...
    <script>
        ...
        function submitProfile() {
            ...
            const consultantType = document.getElementById("consultant-type-display").innerText.trim();
            ...
            formData.append('consultancyType', consultantType);
